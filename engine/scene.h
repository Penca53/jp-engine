...
/// @brief Represents a self-contained part of the game world, managing nodes, cameras, and physics.
class Scene {
 public:
 ...
 private:
  ...
  void InternalUpdate();
  /// @brief Internal method called during the game loop to draw the scene. Draws the root node through each camera.
